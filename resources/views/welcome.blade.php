...
<div id="main-banner" class="banner-one" data-scroll-index="0">
        <div data-src="uploads/slide-1.jpg">
            <div class="camera_caption">
                <div class="container">
                    <h1 class="wow fadeInUp animated">World is greater than five #National Alliance Movement</h1>
                    <p class="wow fadeInUp animated" data-wow-delay="0.2s"></p>
                    <a data-scroll href="#" class="btn btn-light btn-radius btn-brd grd1">Know Us</a>
                </div> <!-- /.container -->
            </div> <!-- /.camera_caption -->
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="message-box">
                        <h4>Who We are</h4>
                        <h2>Welcome to <span> NAPK</span></h2>
